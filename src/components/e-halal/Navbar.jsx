              ...
              {user ? (
                <div className="relative">
                  <button
                    ...
                    className="flex items-center gap-2 p-1 rounded-lg hover:bg-light-green/20 transition-colors"
                  ...
                  {isUserMenuOpen && (
                    <div className="absolute top-full right-0 mt-1 w-56 bg-white rounded-xl shadow-lg border border-gray-100 py-2 animate-slide-down z-50">
                      <div className="px-4 py-2 border-b border-gray-100">
                        <p className="text-sm font-medium text-gray-900 truncate">{user.name}</p>
                        <p className="text-xs text-gray-500 truncate">{user.email}</p>
                      </div>
                      <Link href="/account" className="block px-4 py-2.5 text-sm text-gray-700 hover:bg-light-green/20 transition-colors">
                        My Account &amp; Orders
                      </Link>
                      {isAdmin && (
                        <Link href="/admin" className="block px-4 py-2.5 text-sm text-primary font-medium hover:bg-light-green/20 transition-colors">
                          Admin Panel
                        </Link>
                      )}
                      <button
                ...
                <button
                  ...
                  className="hidden sm:inline-flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-medium text-gray-600 hover:text-primary hover:bg-light-green/20 transition-colors"
                >
          ...
          <div className="lg:hidden bg-white border-t border-gray-100 animate-slide-down">
            ...
            <nav className="p-4 space-y-1">
              ...
              <div className="pt-2 border-t border-gray-100 mt-2">
                {user ? (
                  <>
                    <Link href="/account" className="block px-4 py-2.5 text-sm text-gray-600 hover:text-primary hover:bg-light-green/20 rounded-lg transition-colors">
                      My Account &amp; Orders
                    </Link>
                    {isAdmin && (
                      <Link href="/admin" className="block px-4 py-2.5 text-sm text-primary font-medium hover:bg-light-green/20 rounded-lg transition-colors">
                        Admin Panel
                      </Link>
                    )}
                    <button
                  ...
                  <button
                    onClick={() => signIn('google')}
                    className="w-full text-left px-4 py-2.5 text-sm text-gray-600 hover:text-primary hover:bg-light-green/20 rounded-lg transition-colors"
                  >
                    Sign in with Google
                  </button>
                )}
