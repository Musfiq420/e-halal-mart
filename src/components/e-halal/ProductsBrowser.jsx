...
function ProductsPageContent({ products, categories }) {
  ...
  const filteredProducts = useMemo(() => {
    ...
    return result;
  }, [products, effectiveCategory, effectiveFilter, sortBy, priceRange]);
...
export default function ProductsBrowser({ products, categories }) {
  return (
